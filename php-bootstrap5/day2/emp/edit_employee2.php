            ...
            <div class="card-body">
                <form action="update_employee.php" method="post" class="row g-3">
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="text" name="emp_code" class="form-control" value="<?= $row['emp_code'] ?>" required>
                    </div>
                    <!-- ชื่อ-นามสกุล -->
                    <div class="col-md-5">
                        <label class="form-label">ชื่อ-นามสกุล</label>
                        <input type="text" name="fullname_th" class="form-control" value="<?= $row['fullname_th'] ?>" required>
                    </div>
                    <!-- อีเมล -->
                    <div class="col-md-4">
                    ...
                    <div class="row mb-3">
                            ...
                            <select name="dept_id" class="form-select" required>
                                ...
                                if ($dept_rs && mysqli_num_rows($dept_rs) > 0):
                                    while ($dep = mysqli_fetch_assoc($dept_rs)):
                                        $selected = ($dep['id'] == $row['dept_id']) ? 'selected' : '';
                                ?>
                        ...
                        <div class="col-md-2">
                            ...
                            <input type="number" name="salary" class="form-control" step="0.01" min="0" value="<?= $row['salary'] ?>">
                        </div>
                        <!-- วันที่เริ่มงาน -->
                        <div class="col-md-2 mb-3">
                            <label class="form-label">วันที่เริ่มงาน</label>
                            <input type="date" name="hired_at" class="form-control" value="<?= $row['hired_at'] ?>">
                        </div>
                    </div>
